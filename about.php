...
$changelog = array(
	'0.8.x' => array(
		'0.8.10' => array(
			array('n',"Синхронизация стены теперь на ajax."),
		),
		'0.8.9' => array(
		...
		'0.8.7' => array(
			...
			array('u',"Добавлена возможность исключать из очереди фотографии, документы."),
			...
			array('bf',"Исправлена ошибка в проверке типа для очереди закачки."),
			array('bf',"Исправлено отображение документа в сообщениях (стене)."),
