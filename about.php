...
$changelog = array(
	'0.8.x' => array(
		'0.8.5' => array(
			array('n',"Возможность сохранения музыки возвращается. К сожалению не в полноценном виде как API, и неизвестно на какое время, но пока работает. Спасибо за это @in4in-dev ♥"),
